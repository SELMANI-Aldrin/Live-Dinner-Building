...
def PDFFile():
	...
	rendered = render_template("DBill.html", FStarter=starter, FMain = main, FCheese = cheese, FDessert = dessert, FStarterPrice = StarterP, FMainPrice = MainP, FCheesePrice = CheeseP, FDessertPrice = DessertP, TotalPrice = Total, heure= h, minute= m, date = d )	
	pdf = pdfkit.from_string(rendered, False, css = 'Dbill.css')
